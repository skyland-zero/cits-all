...
export async function editApi(id: string, data: any) {
  return requestClient.post<any>(`/basic/role/${id}/update`, data);
}
...
export async function deleteApi(id: string) {
  return requestClient.post<any>(`/basic/role/${id}/delete`);
}
...
export async function setMenusApi(id: string, permissions: any[]) {
  return requestClient.post<any>(`/basic/role/${id}/menus`, { permissions });
}
